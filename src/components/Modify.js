  ...
  return (
    <div className="px-8">
      ...
      <div className="flex flex-no-wrap">
        ...
        <div className="w-80 rounded-t-xl absolute sm:relative bg-[#f2f0f0] shadow h-[300vh] flex-col justify-between hidden sm:flex">
          <div className="px-8 py-8">
            <ul className="">
              ...
              <Link to="/create">
                <li className="flex w-full justify-between  hover:py-4 hover:px-2 hover:rounded-xl hover:bg-[#fad8c7] hover:text-[#f6783a] font-semibold text-[#455a64] transition-all  cursor-pointer items-center my-8">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="w-full flex-col flex flex-wrap relative  mb-12 p-8 rounded shadow-xl">
          <div className="absolute w-full top-0 left-20 text-xl text-[#f6783a] font-bold">
            Editez un entrepot existant
          </div>
              ...
              >
                <form
                  ...
                  onSubmit={(e) => {
                    ...
                    axios
                      .put(
                        `https://tame-veil-tuna.cyclic.app/entrepot/${data._id}`,
                        updatedData
                      )
                ...
                >
                  <div className="flex py-8 space-x-2">
                    <Input
                      ...
                      onChange={(e) =>
                        handleChange(index, "libelle", e.target.value)
                      }
                    />
                    <Input
                      label="superficie"
                      ...
                      className="border-r border-black"
                      onChange={(e) =>
                        handleChange(index, "superficie", e.target.value)
                      }
                    />
                  </div>
                  <Input
                  ...
                  <img
                    src={data.profilPic}
                    className="h-[250px] object-cover ml-auto mr-auto  w-[300px] "
                  />
