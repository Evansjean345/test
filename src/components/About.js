...
function About() {
  ...
  const [historyTwo, setHistoryTwo] = useState({
     title : '' ,
     text : ''
  });
  const [historyThree, setHistoryThree] = useState({
     title : '' ,
     text : ''
  });
  const [historyFour, setHistoryFour] = useState({
     title : '' ,
     text : ''
  });
  ...
  useEffect(() => {
    axios
      .get("https://caauri-api.cyclic.cloud/absec/6567cf27ea164cafe5de6aa3")
      .then((res) => {
        setSkillOne(res.data.skillOne)
        setSkillTwo(res.data.skillTwo)
        setSkillThree(res.data.skillThree)
        setSkillFour(res.data.skillFour)
        setSkillFive(res.data.skillFive)
        setHistoryOne(res.data.HistoryOne)
        setHistoryTwo(res.data.HistoryTwo)
        setHistoryThree(res.data.HistoryThree)
        setHistoryFour(res.data.HistoryFour)
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put("https://caauri-api.cyclic.cloud/about/absec/6567cf27ea164cafe5de6aa3", data)
    ...
    <div className="flex flex-no-wrap">
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
          ...
          <form className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="flex">
              <div className="w-1/2 py-8 px-8">
                <strong>Les esprits les plus brillants</strong>
                <Textarea
                  variant="standard"
                  label="Competence 1"
                  value={skillOne}
                ...
                />
                 <strong>Engagez les utilisateurs</strong>
                <Textarea
                  variant="standard"
                  label="Competence 2"
                  value={skillTwo}
                ...
                />
                 <strong>Des solutions d'affaires</strong>
                <Textarea
                  variant="standard"
                  label="Competence 3"
                  value={skillThree}
                ...
                />
                 <strong>Peu importe où tu vas</strong>
                <Textarea
                  variant="standard"
                  label="Competence 4"
                  value={skillFour}
                ...
                />
                 <strong>Préférence personnalisée</strong>
                <Textarea
                  variant="standard"
                  label="Competence 5"
                  value={skillFive}
            ...
            {/*    <Textarea
                  variant="standard"
                  label="paragraphe 3"
                  value={firstSection.p3}
                  onChange={(e) => {
                    const value = e.target.value;
                    setFirstSection((prevRecipient) => ({
                      ...prevRecipient,
                      p3: value,
                    }));
                  }}
              ...
              <div className="w-1/2 py-8 px-8">
              <strong>History : paragraphe 1</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={historyOne?.title}
                  onChange={(e) => {
                    const value = e.target.value;
                    setHistoryOne((prevRecipient) => ({
                      ...prevRecipient,
                      title: value,
                    }));
                  }}
                ...
                />
          <strong>History : paragraphe 2</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={historyTwo?.title}
                  onChange={(e) => {
                    const value = e.target.value;
                    setHistoryTwo((prevRecipient) => ({
                      ...prevRecipient,
                      title: value,
                    }));
                  }}
                ...
                />
                  <strong>History : paragraphe 3</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={historyThree?.title}
                  onChange={(e) => {
                    const value = e.target.value;
                    setHistoryThree((prevRecipient) => ({
                      ...prevRecipient,
                      title: value,
                    }));
                  }}
                ...
                />
                  <strong>History : paragraphe 4</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={historyFour?.title}
                  onChange={(e) => {
                    const value = e.target.value;
                    setHistoryFour((prevRecipient) => ({
                      ...prevRecipient,
                      title: value,
                    }));
                  }}
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
             src="https://absec.netlify.app/about"
