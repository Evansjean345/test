...
function Create() {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .post("https://tame-veil-tuna.cyclic.app/entrepot", formData)
      .then((res) => {
    ...
    <div className="px-8">
      <div className="flex px-8 mt-8 justify-between flex-nowrap">
        ...
        <div className="flex flex-nowrap  space-x-8">
          ...
          <div className="flex relative px-4 py-2 hover:scale-95 transition-all rounded-xl cursor-pointer bg-[#f0f0f0] items-center justify-center text-[#455a64] text-sm font-semibold">
      ...
      <div className="flex flex-no-wrap">
        ...
        <div className="w-80 rounded-t-xl absolute sm:relative bg-[#f2f0f0] shadow h-[300vh] flex-col justify-between hidden sm:flex">
          <div className="px-8 py-8">
            <ul className="">
              <Link to="/">
                <li className="flex w-full justify-between   hover:py-4 hover:px-2 hover:rounded-xl hover:bg-[#fad8c7] hover:text-[#f6783a] font-semibold text-[#455a64] transition-all cursor-pointer items-center">
              ...
              <Link to="/about">
                <li className="my-8 flex w-full justify-between font-semibold py-4 px-2 rounded-xl bg-[#fad8c7] text-[#f6783a]  cursor-pointer items-center">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <Link to="/login">
                <li className="flex cursor-pointer w-full justify-between  hover:py-4 hover:px-2 hover:rounded-xl hover:bg-[#fad8c7] hover:text-[#f6783a] font-semibold text-[#455a64] transition-all cursor-pointer items-center mb-8">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="w-full flex flex-wrap relative  mb-12 p-8 rounded shadow-xl">
          <div className="absolute top-0 left-20 text-xl text-[#f6783a] font-bold">
            Créez un entrepot
          </div>
        ...
        <Dialog open={open} handler={handleOpen} size="xl">
          ...
          <DialogBody divider className="text-semibold">
            La creation a bien été effectuée
          </DialogBody>
          <DialogFooter>
            <Button
              variant="gradient"
