...
function AllCourses() {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .post("https://caauri-api.cyclic.cloud/courses/absec", formData)
      .then((res) => {
  ...
  const [allData, setAllData] = useState([
    { title: "", lessons: '', cover: null },
  ]);

  useEffect(() => {
    axios
      .get("https://caauri-api.cyclic.cloud/courses/absec")
      .then((res) => {
        setAllData(res.data);
      })
            ...
            </li>
     {
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
            ...
            >
              <form
                ...
                onSubmit={(e) => {
                  ...
                  axios
                    .put(
                      `https://caauri-api.cyclic.cloud/courses/absec/${data._id}`,
                      updatedData
                    )
              ...
              >
                <div className="flex py-8 space-x-2">
                  ...
                  <Input
                    ...
                    className="border-r border-black"
                    onChange={(e) =>
                      handleChange(index, "lessons", e.target.value)
                    }
                  />
                </div>
                <img
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
            src="https://absec.netlify.app/courses"
